...
<p>After the ~ {props.minutes} minute installation, your browser will launch a new tab to the <a href="https://github.com/kubefirst/console">kubefirst Console</a>, which will help you navigate your new suite of tools running in your new {props.cloud} cluster.</p>
