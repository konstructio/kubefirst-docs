...
![kubefirst Cluster Provisioning](../img/kubefirst/getting-started/cluster-template.png)
...
![kubefirst Cluster Provisioning](../img/kubefirst/getting-started/cluster-binding.png)
