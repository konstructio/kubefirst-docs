...
import AzureHeader from './img/azure/header.svg';
...
<div className="row">
    ...
    <div className="col col--4 margin-bottom--lg">
        <div className="card">
            ...
            <div className="card__footer">
                <form>
                    <button className="button button--secondary button--block" formAction="azure/overview/">View install instructions</button>
                </form>
            </div>
        </div>
    </div>
