...
[GitHub](../../getting-started/repositories.mdx) repositories managed with Terraform IaC (Infrastructure as Code).

## User management with automated Terraform IaC

Onboard yourself and your team with [GitHub](../../explore/user-creation.mdx).
