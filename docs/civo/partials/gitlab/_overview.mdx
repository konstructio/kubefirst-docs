...
[GitLab](../../getting-started/repositories.mdx) repositories are managed with Terraform IaC (Infrastructure as Code).

## User management with automated Terraform IaC

Onboard yourself and your team with [GitLab](../../explore/user-creation.mdx).
