...
[GitLab](../../getting-started/repositories.mdx) repositories managed with Terraform IaC (Infrastructure as Code).

## User management with automated Terraform IaC

Onboard yourself and your team using terraform automated [Atlantis](../../explore/user-creation.mdx).

## GitOps application delivery with the metaphor sample application

Explore GitOps application delivery and platform integrations with our [metaphor](../../explore/metaphor.mdx) simple application.