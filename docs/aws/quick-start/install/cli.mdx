...
<Tabs groupId="git_provider" defaultValue="github" queryString>
  ...
  <CommonTerminalOutput cloud="AWS"  minutes="25" handoffScreen={GitHubHandoffScreen} />
  ...
  <CommonTerminalOutput cloud="AWS"  minutes="25" handoffScreen={GitLabHandoffScreen} />
