...
When you install the Vultr version of kubefirst, 2 new repositories will be added to your GitLab project as shown here.
...
These GitLab projects (repositories) are being managed in Terraform. As you need additional GitLab projects, just add a new section of Terraform code to `vultr-gitlab/terraform/gitlab/projects.tf`:
