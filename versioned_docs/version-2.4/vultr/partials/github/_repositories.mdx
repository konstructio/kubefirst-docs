...
When you deploy a cluster on Vultr using kubefirst, new repositories will be added to your organization's GitHub account.
...
These {props.name} repositories are being managed in Terraform. As you need additional GitHub repositories, just add a new section of Terraform code to `vultr-github/terraform/github/repos.tf`:
