...
<Tabs groupId="git_provider" defaultValue="github" queryString>
  ...
  <CommonTerminalOutput cloud="DigitalOcean"  minutes="10" handoffScreen={GitHubHandoffScreen} />
  ...
  <CommonTerminalOutput cloud="DigitalOcean"  minutes="10" handoffScreen={GitLabHandoffScreen} />
