...
See our [guide](../../common/terraform.mdx#how-can-i-use-atlantis-to-add-a-new-user-on-my-github-backed-installation) to onboard yourself and your team to the platform.
