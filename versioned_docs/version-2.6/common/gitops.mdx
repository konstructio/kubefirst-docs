...
<Tabs>
    <TabItem value="github" label="GitHub Integration with Argo Workflows">
      <GitHub />
    </TabItem>
    <TabItem value="gitlab" label="GitLab Integration with Argo Workflows">
      <GitLab />
    </TabItem>
</Tabs>
...
![Screenshot of the Cluster details page from the UI installation](../img/console/console-advanced-options.png)
