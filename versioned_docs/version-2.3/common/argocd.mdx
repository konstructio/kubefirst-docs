...
import GitHubArgoCD from '../common/partials/github/_argocd.mdx';
import GitLabArgoCD from '../common/partials/gitlab/_argocd.mdx';
...
<Tabs>
    <TabItem value="github" label="GitHub registry applications">
        <GitHubArgoCD />
    </TabItem>
    <TabItem value="gitlab" label="GitLab registry applications">
        <GitLabArgoCD />
    </TabItem>
</Tabs>
