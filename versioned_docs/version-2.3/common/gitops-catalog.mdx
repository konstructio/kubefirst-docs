...
Please note that the GitOps Catalog was updated in patch 2.3.8 to support multicluster and template-based installations. Prior to 2.3.8, the catalog was only able to install applications to the management cluster.
